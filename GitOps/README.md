...
1. **Jenkins (CI)** builds versioned Docker images, pushes them to Docker Hub (`onkar1502/wanderlust-backend:vX.Y.Z`), updates `kubernetes/*.yaml` manifests, and commits/pushes back to GitHub.
